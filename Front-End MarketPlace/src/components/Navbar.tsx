      ...
      <div className="flex items-center gap-4">
        ...
        {!user?.id ? (
          ...
          <div className="flex items-center gap-4 mr-2">
            <Link
              to="/login"
              className="px-4 py-2 text-[var(--color-text-invert)] font-medium hover:transition-all hover:bg-[var(--color-secondary)] rounded-lg hover:brightness-110"
            >
              Login
            </Link>
            <Link
          ...
          <>
            ...
            <div className="relative">
              <button
                onClick={() => openInbox()}
                className="z-30 p-2 text-[var(--color-text-invert)] rounded-lg hover:bg-[var(--color-secondary)] transition-all duration-200 relative flex items-center justify-center"
              >
